...
/*
	...
	public static AlertDialog showInput(Context context, String title, String hint, final OnInputListener listener) {
		if (context == null) {
			return null;
		}
		final AlertDialog dialog = instanceDialog(context, title, "", hint);
		Button btnCancel = (Button) dialog.findViewById(R.id.cancel_btn);
		btnCancel.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
		...
		btnOk.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				dialog.dismiss();
				if (listener != null) {
					listener.onInput(etContent.getText().toString());
				}
			}
		});
		return dialog;
	...
	/*private static AlertDialog instanceDialog(Context context, String title, String message, String hint) {
